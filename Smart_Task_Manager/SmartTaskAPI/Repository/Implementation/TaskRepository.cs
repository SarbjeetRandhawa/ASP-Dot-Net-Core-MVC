...
namespace SmartTaskAPI.Repository.Implementation
{
    public class TaskRepository : ITaskRepository
    {
        ...
        public async  Task<IEnumerable<TaskItem>> GetAllAsync(string userId)
        {
            ...
            return await _context.Tasks.Include(t => t.Project).Include(t=> t.AssignedToUser).Include(t => t.CreatedByUser).Where(t=> t.AssignedToUserId == userId || t.CreatedByUserId == userId || projectIds.Contains(t.ProjectId)).ToListAsync(); 
        }
    }
}
