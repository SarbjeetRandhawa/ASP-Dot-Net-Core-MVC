...
namespace Inventory_Crud.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<InventoryUser> signInManager, ILogger<LoginModel> logger , UserManager<InventoryUser> userManager, JwtTokenService jwtTokenService)
        {
